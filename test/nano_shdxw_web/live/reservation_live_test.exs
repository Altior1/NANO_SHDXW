defmodule NanoShdxwWeb.ReservationLiveTest do
  use NanoShdxwWeb.ConnCase

  import Phoenix.LiveViewTest
  import NanoShdxw.RoomReservationFixtures

  @create_attrs %{starting_date: "2025-01-23", ending_date: "2025-01-23"}
  @update_attrs %{starting_date: "2025-01-24", ending_date: "2025-01-24"}
